...
@RestController
@RequestMapping("/api")
@Api(description = "books data api")
public class BooksRestApiController {
    ...
    @ApiOperation("operation to get books list of bookshop by passed author first name")
    ...
    @ApiOperation("get books between range from min price to max price")
